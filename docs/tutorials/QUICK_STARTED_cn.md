...
python tools/train.py -c configs/yolov3/yolov3_mobilenet_v1_roadsign.yml --eval -o
```
...
python tools/eval.py -c configs/yolov3/yolov3_mobilenet_v1_roadsign.yml -o
```
...
python tools/infer.py -c configs/yolov3/yolov3_mobilenet_v1_roadsign.yml -o --infer_img=demo/road554.png
```
