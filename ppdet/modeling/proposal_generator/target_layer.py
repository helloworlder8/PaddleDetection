...
class RPNTargetAssign(object):
    ...
    def __call__(self, inputs, anchors):
        ...
        gt_labels, gt_bboxes, gt_deltas = rpn_anchor_target(
            anchors,  #[257796, 4]
            gt_boxes, #[[4, 4],[7, 4]]
        ...
        return gt_labels, gt_bboxes, gt_deltas, bs_num_samples
...
class BBoxAssigner(object):
    ...
    # return rois_with_gt_bbox, gt_classes, tgt_bboxes, tgt_gt_labels, new_rois_num
