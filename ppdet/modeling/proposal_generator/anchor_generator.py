...
class AnchorGenerator(nn.Layer):
    ...
    def forward(self, input):
        grid_sizes = [feature_map.shape[-2:] for feature_map in input] #->[[192, 336], [96, 168], [48, 84], [24, 42], [12, 21]]
        anchors_over_all_feature_maps = self._grid_anchors(grid_sizes) #64,512 16,128 4,032 252
