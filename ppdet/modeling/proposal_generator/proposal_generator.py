...
class ProposalGenerator(object):
    ...
    def __call__(self, pd_scores, pd_deltas, anchors, im_shape):
        ...
        rpn_rois, rpn_rois_scores, rpn_rois_num = generate_proposals(
            pd_scores,
            pd_deltas,
            im_shape,
            anchors,
        ...
        return rpn_rois_scores, rpn_rois, rpn_rois_num, self.post_nms_top_n #[933, 4] [933, 1] [1] 1000
