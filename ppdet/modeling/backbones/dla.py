...
class DLA(nn.Layer):
    """
    DLA, see https://arxiv.org/pdf/1707.06484.pdf  Deep Layer Aggregation
    ...
    def forward(self, inputs):
        outs = []
        feats = self.base_layer(inputs['image']) #[2, 3, 608, 1088] ->[2, 16, 608, 1088]
        ...
        for i in range(self.num_levels):
            ...
            outs.append(feats) #->[2, 16, 608, 1088],[2, 32, 304, 544],[2, 64, 152, 272],[2, 128, 76, 136],[2, 256, 38, 68],[2, 512, 19, 34]
