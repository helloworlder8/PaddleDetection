...
class DLAUp(nn.Layer):
    ...
    def forward(self, inputs): #[2, 16, 608, 1088],[2, 32, 304, 544],[2, 64, 152, 272],[2, 128, 76, 136],[2, 256, 38, 68],[2, 512, 19, 34]
...
class CenterNetDLAFPN(nn.Layer):
    ...
    def forward(self, body_feats): #[2, 16, 608, 1088],[2, 32, 304, 544],[2, 64, 152, 272],[2, 128, 76, 136],[2, 256, 38, 68],[2, 512, 19, 34]

        inputs = [body_feats[i] for i in range(len(body_feats))]

        dla_up_feats = self.dla_up(inputs) #[2, 16, 608, 1088],[2, 32, 304, 544]c[2, 128, 76, 136],[2, 256, 38, 68],[2, 512, 19, 34]->[2, 64, 152, 272],[2, 128, 76, 136],[2, 256, 38, 68],[2, 512, 19, 34]
        ...
        feat = ida_up_feats[-1]# [2, 64, 152, 272],[2, 64, 152, 272],[2, 64, 152, 272]
        if self.with_sge:
