...
def check_gpu(use_gpu):
    ...
    try:
        if use_gpu and not paddle.is_compiled_with_cuda(): #指定了用gpu但是
            logger.error(err)
            sys.exit(1)
    except Exception as e:
        pass
...
def check_version(version='2.2'): #版本号大于2.2
    """
    ...
    version_installed = [
        ...
        paddle_version.rc #paddle version init
    ]
...
def check_config(cfg_dict):
    ...
    if 'log_iter' not in cfg_dict:
        cfg_dict.log_iter = 20
