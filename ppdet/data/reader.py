...
class BaseDataLoader(object):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        # sample transform
        self._sample_transforms = Compose( #单样本转换
    ...
    def __call__(self,
                 ...
                 batch_sampler=None,
                 return_list=False):
        self.dataset = dataset #数据读取者加载数据集
        self.dataset.check_or_download_dataset()
        self.dataset.parse_dataset()
        # get data
        self.dataset.set_transform(self._sample_transforms) #数据加载者回馈给数据集
        # set kwargs
...
@register
class TrainReader(BaseDataLoader): #数据加载器
    __shared__ = ['num_classes'] #类数目
