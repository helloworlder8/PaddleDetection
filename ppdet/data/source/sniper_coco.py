...
from .dataset import _make_dataset, check_file_ext
...
class SniperCOCODataSet(COCODataSet):
    ...
    def __init__(self,
        ...
        self.max_neg_num_per_img = max_neg_num_per_img
    ...
    def init_anno_cropper(self):
        ...
        self.anno_cropper = AnnoCropper(
            ...
            max_neg_num_per_img=self.max_neg_num_per_img,
