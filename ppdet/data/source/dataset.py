...
class DetDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.sample_num = sample_num #采样数目 如果是-1就是遍历整个数据集
        self.repeat = repeat
    ...
    def set_kwargs(self, **kwargs):
        self.mixup_epoch = kwargs.get('mixup_epoch', -1) #比例混合
        self.cutmix_epoch = kwargs.get('cutmix_epoch', -1) #区域替换
...
def check_file_ext(f, extensions=('.jpg', '.jpeg', '.png', '.bmp')):
...
class CommonDataset(object):
    def __init__(self, **dataset_args):
        ...
        self.dataset = getattr(source, type)(**dataset_args) #类的一个初始化
